...
namespace Configure.Hateoas.Extensions
{
	internal static class PayloadExtensions
	{
		internal static object ToFinalPayload(this object originalModel, IList<object> links)
		{
			...
			AssemblyBuilder assemblyBuilder = AssemblyBuilder.DefineDynamicAssembly(new AssemblyName("Configure.Hateoas.Links"), AssemblyBuilderAccess.RunAndCollect);

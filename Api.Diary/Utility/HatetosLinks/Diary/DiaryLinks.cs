                ...
                policy
                  .AddPolicy<DiaryDto>(model =>
                  {
                      model
                          ...
                          .AddRoute(m => m.Id, DiaryEntryController.CreatEentry_Diary, message: "@desc (CreatEntry_Diary for create CreatEntry_Diary by diaryId.) @param  (diaryId : For insert diaryId to diaerEntry , diaryEntrydtoForCreate  diaryEntrydtoForCreate : object  for creating diaryEntry.)");
